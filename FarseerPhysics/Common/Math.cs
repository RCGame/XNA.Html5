...
namespace FarseerPhysics.Common
{
    ...
    {
		public static bool IsClose(Vector2 v1, Vector2 v2, float tolerence)
		{
			return (Vector2.Distance(v1, v2) < tolerence);
		}
        ...
        public static Vector2 CloneVector(Vector2 vector)
        {
        ...
        /// <returns></returns>
        public static Vector2 VectorPolar(float radius, float angle)
        {
            return new Vector2(radius * (float)Math.Cos((double)angle), radius * (float)Math.Sin((double)angle));
        }
